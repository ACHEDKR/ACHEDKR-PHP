<?php
    ...
    //PHP Reporte de tods los pacientes con sus estados
	$query = "SELECT patients.*,pat_to_bed.pat_id, pat_to_bed.bed_id FROM patients, pat_to_bed WHERE patients.pat_id=pat_to_bed.pat_id ORDER BY patients.pat_id DESC";
    ...
    $pdf->Cell(280,10,'REPORTE DE ESTADO PACIENTES',1,1,'C',1);
    $pdf->SetFont('Arial','B',10);
	...
	while($row = $resultado->fetch_assoc())
	{
        ...
        $pdf->CellAjustar(30,12,utf8_decode($row['prioridad']),1,0,'C');

        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="index14.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Camas Libres</p>
                </a>
              </li>
...
<!-- Zona para editar -->
  ...
  <!-- h2 stays for breadcrumbs -->
  <h2>Vista de todas las Camas</h2>
...
<div id="main">
		<h3>Camas Libres</h3>
          <table class="table table-bordered table-striped">
                        ...
                        <?php
								$result=mysqli_query($server,"SELECT * FROM beds WHERE bed_id NOT IN (SELECT bed_id FROM pat_to_bed) ORDER BY bed_id DESC");

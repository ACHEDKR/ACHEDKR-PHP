        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="index12.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
...
<!-- Zona para editar -->
    ...
    <div class="alert alert-warning">
        <strong>Alerta!</strong> Los pacientes aqui listados fueron eliminados y no se puede trabajar con ellos.
    </div>
      <h2>Historial</h2>
					...
					<h3>Pacientes eliminados</h3>
                    	<table class="table table-bordered table-striped">
							<tr>
                                ...
                                <td><b>Fecha de Registro Ingreso </b></td>
                                
                            </tr> 
              <?php
								$result=mysqli_query($server,"SELECT * FROM patients_drop ORDER BY pat_id DESC");

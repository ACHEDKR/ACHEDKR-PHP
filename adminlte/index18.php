<?php
    ...
    //PHP Reporte de los pacientes con cama asignada en el momento

	$query = "SELECT patients.*,pat_to_bed.pat_id, pat_to_bed.bed_id FROM patients, pat_to_bed WHERE patients.pat_id=pat_to_bed.pat_id AND pat_to_bed.bed_id!='0' AND pat_to_bed.bed_id!='none' ORDER BY patients.pat_id DESC";
    ...
    $pdf->Cell(280,10,'REPORTE DE ESTADO PACIENTES CON CAMA ASIGNADA EN EL MOMENTO',1,1,'C',1);
    $pdf->SetFont('Arial','B',10);

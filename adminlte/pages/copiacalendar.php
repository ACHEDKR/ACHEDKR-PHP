                ...
                <div class="card-body">
                  ...
                  <div id="external-events">
                    <?php
								      ...
								      {
								      	echo"<div class='external-event bg-primary'>$row[name] $row[lastname]</div>";
								      }
							      ?>

                   <!--  <div class="external-event bg-success"><a name="paciente">paciente</a></div>
              ...
              <div class="card-body p-0">
                ...
                <section>
                  ...
                  <div id="div1" ondrop="drop(event)" ondragover="allowDrop(event)">
                    <img src="../dist/img/monalisa.jpg" draggable="true" ondragstart="drag(event)" id="drag1" width="300" height="550">
                  </div>
